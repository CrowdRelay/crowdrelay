...
pub async fn register_endpoint(
    ...
    let result = sqlx::query(
        ...
        INSERT INTO fan_push_endpoints (
            workspace_id, fan_id, installation_id, transport,
            endpoint_address, p256dh, auth_secret, active, last_seen_at,
            invalidated_at, last_error_code
        )
        VALUES ($1, $2, $3, $4, $5, $6, $7, true, now(), NULL, NULL)
        ON CONFLICT (workspace_id, installation_id, transport)
        DO UPDATE SET
