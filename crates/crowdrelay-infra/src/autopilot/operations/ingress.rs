...
use crowdrelay_application::autopilot::{
    ...
    AutopilotOutreachStateRepository, AutopilotTeamStateRepository, ContentSourceMutation,
    ...
    TeamOpportunityMutation, TeamOpportunityProgress, UpsertContentSource,
...
use crowdrelay_domain::{
    ExperimentVariantId, ReleasePlanId, TeamOpportunityId,
