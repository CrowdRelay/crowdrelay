...
async fn load_evidence(
    ...
    struct EvidenceRow {
        ...
        observed_incremental_fans_3d: Option<f64>,
    ...
    let rows: Vec<EvidenceRow> = sqlx::query_as(
        ...
        SELECT ge.action_id, ge.opportunity_id, ge.timestamp, ge.audience, ge.target_key,
               ...
               ge.observed_incremental_fans, ge.observed_incremental_fans_3d,
               ge.durable_fans_30d,
    ...
    let evidence: Vec<GrowthEvidence> = rows
        ...
        .map(|row| {
            ...
            GrowthEvidence {
                ...
                observed_incremental_fans_3d: row.observed_incremental_fans_3d,
